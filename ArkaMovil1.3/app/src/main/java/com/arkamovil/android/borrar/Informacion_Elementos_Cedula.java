...
public class Informacion_Elementos_Cedula extends Dialog {
    ...
    public Informacion_Elementos_Cedula(Activity a, int i) {
        super(a);
...
//        total.setText(datos.getTotal().get(i));
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TablaInventarioCedula cerrarDialog = new TablaInventarioCedula();
    ...
    public void onBackPressed() {
        Toast.makeText(c, "Por favor espere a que se active el botón cerrar", Toast.LENGTH_LONG).show();
    }
