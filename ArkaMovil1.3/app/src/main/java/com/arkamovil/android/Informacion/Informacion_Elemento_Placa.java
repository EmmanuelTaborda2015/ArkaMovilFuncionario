...
public class Informacion_Elemento_Placa extends Dialog {
    ...
    private WS_ElementoPlaca datos;

    public Informacion_Elemento_Placa(Activity a, int i, WS_ElementoPlaca datos) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(datos.getMarca().size() == 0){
            marca.setText("Sin Información");
            serie.setText("Sin Información");
            nivel.setText("Sin Información");
            ubicacion.setText("Sin Información");
            valor.setText("Sin Información");
            tipo_bien.setText("Sin Información");
            fecha_salida.setText("Sin Información");
        }else{
